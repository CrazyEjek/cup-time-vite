                ...
                <div className="footer__info">
                    ...
                    <ul className="footer__developers">
                        <li className="footer__developer">
                            Designer: <a className="footer__developer-link" href="https://t.me/Marshmallooww">Anastasia Ilina</a>
                        </li>
                        <li className="footer__developer">
                            Developer: <a className="footer__developer-link" href="https://vk.com/myejek">Egor Bondarenko</a>
                        </li>
                    </ul>
                </div>
